...
namespace SmartMeetingRoom.Azure.Initializer
{
    public class Program
    {
        ...
        /// <summary>
        /// Creating Collection in DocumentDB 
        /// </summary>
        /// <returns></returns>
        private static async Task InitializeDocumentDb()
        {
            ...
            DocumentCollection eventsCollection = await documentClient.CreateDocumentCollectionAsync(db.SelfLink, new DocumentCollection() { Id = ConfigurationManager.AppSettings["EmployeesCollectionName"] });
            Console.WriteLine("\tCalender collection");
            DocumentCollection visitsCollection = await documentClient.CreateDocumentCollectionAsync(db.SelfLink, new DocumentCollection() { Id = ConfigurationManager.AppSettings["CalendersCollectionName"] });
        ...
        /// <summary>
        /// Initialize Azure Storage Face Storage
        /// </summary>
        /// <returns></returns>
